...
<input class="input-style" name="subject" type="text" placeholder="write subject here" required>
<hr>
<textarea class="input-style" name="body" placeholder="Write Your Message Here......" required></textarea>
<hr>
